...
public class UserDaoImpl implements UserDao {
    ...
    public Integer createUser(UserRegisterRequest userRegisterRequest) {
        ...
        namedParameterJdbcTemplat.update(sql, new MapSqlParameterSource(map), keyHolder);
    ...
    public User getUserById(Integer userId) {
        ...
        List<User> userList = namedParameterJdbcTemplat.query(sql, map, new UserRowMapper());
